      ...
      <div className="mx-auto max-w-5xl">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative z-10 space-y-6 md:space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-purple-200/50 bg-purple-50/50 px-4 py-2 backdrop-blur-sm">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <button
                ...
                className="rounded-2xl border-2 border-gray-200 bg-white px-18 py-3.5 font-semibold text-gray-900 transition-all hover:bg-gray-50 hover:scale-[1.02] active:scale-[0.98]"
              >
                체험 하기
              </button>
            </div>
              ...
              <div className="relative z-10 w-[240px] overflow-hidden rounded-[40px] border-8 border-gray-800 bg-white shadow-2xl sm:w-[280px] md:w-[300px]">
                <div className="aspect-[8/16] bg-white p-6">
                  <div className="space-y-4">
                    {/* Instagram */}
                    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-br from-gray-50 to-white p-4 shadow-sm">
